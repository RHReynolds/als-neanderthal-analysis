...
- As we are using top 0.5%, 1% and 2% these negative values do not affect the XP-EHH annotations (nor the closely related iHS, which is also based on EEH). **If we choose to run these annotations as continuous annotations, we should be careful to remove these SNPs from annotation.** 
